...
const translations = {
  ...
  'feature.lago': { es: 'Lago', en: 'Lake', de: 'See' },
  'feature.piscina': { es: 'Piscina', en: 'Pool', de: 'Pool' },
  'feature.jardin': { es: 'Jardín', en: 'Garden', de: 'Garten' },
  'feature.terraza': { es: 'Terraza', en: 'Terrace', de: 'Terrasse' },
  'feature.garage': { es: 'Garaje', en: 'Garage', de: 'Garage' },
  'feature.amueblado': { es: 'Amueblado', en: 'Furnished', de: 'Möbliert' },
  'feature.seguridad': { es: 'Seguridad', en: 'Gated', de: 'Bewacht' },
  'feature.aire_acondicionado': { es: 'Aire Acondicionado', en: 'A/C', de: 'Klimaanlage' },
  'feature.acceso_playa': { es: 'Acceso a Playa', en: 'Beach Access', de: 'Strandzugang' },
  'feature.vista_panoramica': { es: 'Vista Panorámica', en: 'Panoramic View', de: 'Panoramablick' },
  ...
  'filter.location': { es: 'Ubicación', en: 'Location', de: 'Lage' },
  'filter.amenities': { es: 'Comodidades', en: 'Amenities', de: 'Ausstattung' },
