      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            ...
            <span className="text-accent-600">ideal</span> en Honduras
          </motion.h1>
          ...
          >
            Casas, terrenos y apartamentos con verificación legal.
            Precios transparentes en dólares y lempiras.
          </motion.p>
        </div>
